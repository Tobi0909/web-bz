...
@Component({
  selector: 'app-shop-christmas',
  templateUrl: './shop-christmas.component.html',
  styleUrls: ['./shop-christmas.component.css']
})
export class ShopChristmasComponent implements OnInit {
