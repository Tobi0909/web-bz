...
@Component({
  selector: 'app-shop-mothersday',
  templateUrl: './shop-mothersday.component.html',
  styleUrls: ['./shop-mothersday.component.css']
})
export class ShopMothersdayComponent implements OnInit {
