...
@Component({
  selector: 'app-shop-birthday',
  templateUrl: './shop-birthday.component.html',
  styleUrls: ['./shop-birthday.component.css']
})
export class ShopBirthdayComponent implements OnInit {
